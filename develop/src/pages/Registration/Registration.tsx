  ...
  return (
    <div className="registration-page">
      <div className="registration-page__card">
        ...
        {registrationStep === 2 && (
          <>
            <h2 className="registration-page__card-title">Shipping address</h2>
            <form className="registration-page__card-form" onSubmit={handleSubmitForm}>
              <div>
                <input
                  type="text"
                  name="sign_country"
        ...
        {registrationStep === 3 && (
          <>
            <h2 className="registration-page__card-title">Billing address</h2>
            <form className="registration-page__card-form" onSubmit={handleSubmitForm}>
              <input
                type="text"
                name="sign_country"
