...
import { addProductToCart, changeQuantityInCart } from "../../client_Api/carts";
...
const Header: React.FC = () => {
  ...
  const addProduct = async () => {
    ...
    const p9 = "9a23a487-9366-49d2-9b62-f885b5d95334";

    const responce = await changeQuantityInCart(p8, 0);
